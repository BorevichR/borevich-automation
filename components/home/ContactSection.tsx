...
const benefits = [
  ...
  },
  {
    ...
    description: "Понимание, какие процессы и задачи имеет смысл автоматизировать и подключить к ИИ в первую очередь, чтобы разгрузить команду и ускорить работу с клиентами.",
  },
  {
        ...
        >
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-4">
              Диагностика не потребует много времени, после её прохождения мы свяжемся с вами для согласования следующего шага.
            </p>
          </div>
        </motion.div>
      </div>
